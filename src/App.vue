<template>
  ...
  <div id="app">
    ...
    <ComTexto etiquetaProp="nombre" v-model="producto.nombre"/>
    <br>
    <ComTexto etiqueta-prop="precio" v-model="producto.precio"/>
    <br>
    <ComTexto etiqueta-prop="categoria" v-model="producto.categoria"/>
    <br>
